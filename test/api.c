...
main(){
  ...
  simplet_map_add_style(map, SIMPLET_POLYGON_FILL, "#cc0000");
  simplet_map_add_style(map, SIMPLET_STROKE, "#aaaaaa");
  simplet_map_add_rule(map, SIMPLET_FIELD_FILTER_LT, "TEST", 4);
  simplet_map_add_style(map, SIMPLET_POLYGON_FILL, "#aa0000");
  simplet_map_add_style(map, SIMPLET_STROKE, "#444444");
  simplet_map_add_rule(map, SIMPLET_FILTER_ALL, NULL, NULL);
