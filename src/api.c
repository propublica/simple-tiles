...
main(){
  ...
  simplet_map_set_bounds(map, -179.231086, 17.831509, -165.859681, 71.441059);
  // Only one layer per map for now
  simplet_map_add_layer(map, "/Users/jladmin/dev/simple-tiles/data/tl_2010_us_cd108.shp");
  simplet_map_add_rule(map,  "SELECT * from tl_2010_us_cd108 where STATEFP00 = '5'");
  simplet_map_add_style(map, "fill",   "#cc0000");
  simplet_map_add_style(map, "stroke", "#aaaaaa");
  simplet_map_add_rule(map,  "SELECT * from tl_2010_us_cd108 where STATEFP00 = '10'");
